...
class DataColumn {
  ...
  /// The column heading.
  ///
  /// The String version of the column heading which can be used for semantics
  /// annoucements to help accessibility users make sense of information in
  /// [DataCell].
...
class DataRow {
  ...
  /// The row heading.
  ///
  /// The heading that summarizes what this row is about, which can be used for
  /// semantics annoucements to help accessibility users make sense of information
  /// in [DataCell].
  final String heading;
