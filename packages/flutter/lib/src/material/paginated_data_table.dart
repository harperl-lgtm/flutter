...
class PaginatedDataTableState extends State<PaginatedDataTable> {
  ...
  Widget build(BuildContext context) {
    ...
    final String sortOrder = widget.sortAscending ? 'ascending' : 'descending';
        ...
        builder: (BuildContext context, BoxConstraints constraints) {
          return Column(
            ...
            children: <Widget>[
                    ...
                    children: [
                      ...
                      if (widget.sortColumnIndex != null)
                        Semantics(
                          namesRoute: true,
                          label:
                              ', Sorted by ${widget.columns[widget.sortColumnIndex!].heading}, $sortOrder',
                        ),
                    ],
                  ),
                ),
              Semantics(
                label:
                    'Table Content, showing row ${_firstRowIndex + 1} to row ${_firstRowIndex + widget.rowsPerPage}',
