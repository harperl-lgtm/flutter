...
void main() {
  ...
  testWidgets('Swiping down a BottomSheet should dismiss it by default',
    ...
    await tester.drag(find.text('BottomSheet'), const Offset(0.0, 188.0));
  ...
  testWidgets(
    ...
    // Swipe the bottom sheet to dismiss it.
    await tester.drag(find.text('BottomSheet'), const Offset(0.0, 198.0));
    await tester.pumpAndSettle(); // Bottom sheet dismiss animation.
    expect(showBottomSheetThenCalled, isTrue);
    expect(find.text('BottomSheet'), findsNothing);
  });
                ...
                ElevatedButton(
                  ...
                  onPressed: () {
                    sheetController1 =
                      ...
                      (BuildContext context) => Text('BottomSheet 1'),
                    );
                  },
                ),
                ElevatedButton(
                  ...
                  onPressed: () {
                    Scaffold.of(context).showBottomSheet<void>(
                      (BuildContext context) => Text('BottomSheet 2'),
                    );
                  },
                ),
                ElevatedButton(
  ...
  group('Modal BottomSheet avoids overlapping display features', () {
    testWidgets('positioning using anchorPoint', (WidgetTester tester) async {
      ...
      showModalBottomSheet<void>(
        context: context,
        builder: (BuildContext context) {
          return const Placeholder(fallbackHeight: 279);
        },
    ...
    testWidgets('positioning using Directionality',
      ...
      showModalBottomSheet<void>(
        context: context,
        builder: (BuildContext context) {
          return const Placeholder(fallbackHeight: 289);
        },
      );
      await tester.pumpAndSettle();
  ...
  group('constraints', () {
    testWidgets('No constraints by default for bottomSheet property',
        (WidgetTester tester) async {
    ...
    testWidgets('Theme constraints used for bottomSheet property',
        (WidgetTester tester) async {
      await tester.pumpWidget(MaterialApp(
        theme: ThemeData(
